...
_a1z_planner_hw = galaxea_a1z_hardware(
    "arm",
    gripper=True,
...
galaxea_a1z_planner_coordinator = autoconnect(
    ...
    coordinator(
        ...
        tasks=[
            trajectory_task(_a1z_planner_hw, priority=10),
            eef_twist_task(
                _a1z_planner_hw,
                ...
                params={
                    ...
                    # The wrist DCW optical forward axis is aligned with tool
                    # +X, so visual-servo commands must follow the moving tool
                    # frame rather than the fixed world frame.
                    "twist_frame": "eef",
                },
            ),
        ],
